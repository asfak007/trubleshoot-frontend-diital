...
Route::group(['prefix' => 'auth', "middleware" => "guest"], function () {
    ...
    Route::group(['prefix' => 'handyman', 'as' => 'handyman.', "controller" => HandymanController::class], function () {
        ...
        Route::middleware(['handyman'])->group(function () {
            ...
            Route::get('/booking/details/{booking}', [HandymanBookingController::class, "details"])->name("booking.details");
            ...
            Route::post('/booking/schedule/start', [HandymanBookingController::class, "start"])->name("schedule.start");
            Route::post('/booking/schedule/stop', [HandymanBookingController::class, "stop"])->name("schedule.stop");
        });
    });
