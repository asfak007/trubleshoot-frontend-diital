            ...
            <div class="card">
                <div class="card-body p-4">
                    <form class="row g-3" id="categoryForm" method="Post"
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="zone_id" id="zoneSelect" class="form-select">
                                ...
                                @foreach($zones as $item)
                                    <option value="{{ $item->id }}"{{ $service->zone_id == $item->id ? 'selected' : ''  }}>{{ $item->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="col-md-4">
                            <label for="input4" class="form-label">Assign Service To Provider</label>
                            <select id="input4" name="provider_id" class="form-select" required>
                        ...
                        <div class="col-md-4">
                            ...
                            <select id="input5" name="price_type" class="form-select">
                                ...
                                <option value="hourly" {{ $service->price_type === 'hourly' ? 'selected' : '' }}>Hourly
                                </option>
                            </select>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" name="discount" class="form-control" id="input1"
                                   placeholder="First Name" value="{{ $service->discount }}">
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <label for="input5" class="form-label">Status</label>
                            <select id="input5" class="form-select" name="status">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control" name="long_description" id="editor" placeholder="Address ..."
                                      rows="5">{{ $service->long_description }}</textarea>
                        </div>
                        <div class="mb-3">
                            @if ($service->image)
                                ...
                                <div class="mb-3">
                                    ...
                                    <img id="existingImage" src="{{ config('app.url') . $service->image }}"
